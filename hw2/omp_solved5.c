...
#pragma omp parallel shared(a, b, nthreads, locka, lockb) private(tid)
  ...
  #pragma omp sections nowait
    ...
    #pragma omp section
      ...
      for (i=0; i<N; i++)
        a[i] = i * DELTA;
      // Bug 1: Thread 1 and 2 work on section 1 and section 2 respectly. While a thread finish its own array initialization, they both hold their lock and try to get others lock. One way out is to release their own lock after they finish their array initialization.
